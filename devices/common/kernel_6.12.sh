...
cp -rf --parents target/linux package/boot package/firmware package/kernel package/libs package/network package/system package/utils config/Config-kernel.in ../
cd -
