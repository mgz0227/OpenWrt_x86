From 0428fe06c8f2539cbd3a531c50b09fd96e25e61a Mon Sep 17 00:00:00 2001
From: gongzi miao <miaogongzi0227@gmail.com>
Date: Thu, 18 Jun 2026 06:29:40 +0800
Subject: [PATCH] Revert "kernel: remove legacy iptables patches"

This reverts commit bd13b32899f0684f283dc14f9d552bba903f6ea7.
---
 ...
 create mode 100644 target/linux/generic/pending-6.18/610-netfilter_match_bypass_default_checks.patch
 create mode 100644 target/linux/generic/pending-6.18/611-netfilter_match_bypass_default_table.patch
 create mode 100644 target/linux/generic/pending-6.18/612-netfilter_match_reduce_memory_access.patch
...
index 00000000000000..fd22200a848404
--- /dev/null
...
new file mode 100644
index 00000000000000..9f0efe4ec417cc
--- /dev/null
...
new file mode 100644
index 00000000000000..7f291fc0083bc8
--- /dev/null
...
+ 		return false;
+ 
diff --git a/target/linux/generic/pending-6.18/610-netfilter_match_bypass_default_checks.patch b/target/linux/generic/pending-6.18/610-netfilter_match_bypass_default_checks.patch
new file mode 100644
index 00000000000000..fd22200a848404
--- /dev/null
+++ b/target/linux/generic/pending-6.18/610-netfilter_match_bypass_default_checks.patch
@@ -0,0 +1,110 @@
+From: Felix Fietkau <nbd@nbd.name>
+Subject: kernel: add a new version of my netfilter speedup patches for linux 2.6.39 and 3.0
+
...
+
+ 	*dstptr += sizeof(struct compat_ipt_entry);
diff --git a/target/linux/generic/pending-6.18/611-netfilter_match_bypass_default_table.patch b/target/linux/generic/pending-6.18/611-netfilter_match_bypass_default_table.patch
new file mode 100644
index 00000000000000..8185a8b0dfafa9
--- /dev/null
+++ b/target/linux/generic/pending-6.18/611-netfilter_match_bypass_default_table.patch
@@ -0,0 +1,106 @@
+From: Felix Fietkau <nbd@nbd.name>
+Subject: netfilter: match bypass default table
+
...
+ 	do {
+ 		const struct xt_entry_target *t;
diff --git a/target/linux/generic/pending-6.18/612-netfilter_match_reduce_memory_access.patch b/target/linux/generic/pending-6.18/612-netfilter_match_reduce_memory_access.patch
new file mode 100644
index 00000000000000..7f291fc0083bc8
--- /dev/null
+++ b/target/linux/generic/pending-6.18/612-netfilter_match_reduce_memory_access.patch
@@ -0,0 +1,22 @@
+From: Felix Fietkau <nbd@nbd.name>
+Subject: netfilter: reduce match memory access
+
